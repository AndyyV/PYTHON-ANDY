...
for i in range(3): 
    ...
    if usuario == "BCC-2215" and pin == 225125:
        ...
        if opcion == 1:
            ...
            if deposito > 2000: 
                print("La cantidad excede el límite, intentalo de nuevo")
                break 
            if deposito == 2000: 
                palabra = "dos mil"
                break 
            if deposito >= 1000 and deposito < 2000:
                palabra = "mil "
                residuo = deposito % 1000
            elif deposito < 1000:    
                residuo = deposito
            for c in centenas: 
                a = residuo % 100
